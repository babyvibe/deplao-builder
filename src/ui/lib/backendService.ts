/**
 * Backend Service — Giao tiếp với Backend Server cho CRM nhóm Zalo.
 *
 * Backend xử lý: quét nhóm ẩn và chia sẻ nhóm.
 ...
 * Không kiểm tra gói hoặc ngày hết hạn; API quét được gọi trực tiếp.
 */
